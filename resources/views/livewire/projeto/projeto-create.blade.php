<div class="p-4 rounded shadow-sm form-container bg-light">
    ...
    <form wire:submit="store" method="POST">
        ...
        <div class="mb-3 @error('visibility') {{ 'has-error' }} @enderror">
        ...
        <div class="mb-3 @error('priority') {{ 'has-error' }} @enderror">
        ...
        <div class="mb-3 @error('start_date') {{ 'has-error' }} @enderror">
            <label for="start_date" class="form-label">Data de Início</label>
            <input type="date" class="form-control" id="start_date" name="start_date" wire:model="start_date">
        </div>

        <div class="mb-3 @error('end_date') {{ 'has-error' }} @enderror">
